...
# Learning how to use Purrr

 call packages and data to be used throughout this code.
```{r}
library(tidyverse)
...
Pluck is a function that can deep within data structures to check, change, and update data.
```{r}
##pluck
...
#has_element tells if there exists an element with that name in a data frame.
